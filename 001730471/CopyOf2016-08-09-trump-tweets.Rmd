...
setup_twitter_oauth("33SYzFa0ryc5AYRpXAJaEHLr7",
                    "VTvBluu6Ir6kcN8VJIeArQJ4YW8nfaoLVqaX7ebLlVyBuU4QBG",
                    "905635427360669696-rvIZvxqZ9Q2t4mdH3GdMYkk9Dkkyhaq",
                    "ksbjrKfp3esAwSx7mqUibm1MPtmRZDu3XlYFFULfDlwnk")

# We can request only 3200 tweets at a time; it will return fewer
# depending on the API
trump_tweets <- userTimeline("realDonaldTrump", n = 3200, includeRts = T)
